...
use crate::ethereum::{create_new_wallet, get_balance, GothamSigner, GothamWallet, send_transaction, TransactionDetails, transfer_erc20, TransferDetails};
use crate::Settings;
...
pub struct NewEvmWalletArgs {
    ...
    #[arg(long, use_value_delimiter = true, value_delimiter = ',', help = "Hierarchical Deterministic path")]
    pub hd_path: Vec<u32>,
}
...
pub struct SendEvmWalletArgs {
    ...
    #[arg(long, help = "Maximum amount of gas units this transaction can consume")]
    pub gas_limit: Option<u128>,

    #[arg(long, help = "Amount of Giga-Wei to pay for gas (10^9 Giga-Wei = 1 ETH)")]
    pub gas_price: Option<u128>,

    #[arg(long, help = "Sequentially incrementing counter to indicates transaction number")]
...
pub async fn evm_commands(settings: Settings, top_args: &EvmArgs) -> Result<(), Box<dyn std::error::Error>> {
