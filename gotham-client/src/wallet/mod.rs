...
impl Wallet {
    ...
    // TODO: handle fees
    pub fn select_tx_in<E: BalanceFetcher>(&self, amount_btc: f32, fetcher: &mut E) -> Vec<GetListUnspentResponse> {
        // greedy selection
    ...
    fn get_all_addresses_balance<E: BalanceFetcher>(&self, fetcher: &mut E) -> Vec<GetBalanceResponse> {
